...
For this repository to be installed as PWA in mobile devices as well as in Windows/iOS/Linux desktop go to: https://thenocoder.github.io/pwa-via-iframe/example-ipwa/
